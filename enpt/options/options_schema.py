        ...
        schema=dict(
            ...
            atmospheric_correction=dict(
                ...
                schema=dict(
                    ...
                    isofit_surface_optimization=dict(type='string', required=False,
                                                     allowed=['default', 'minerals', 'custom']),
...
parameter_mapping = dict(
    ...
    land_ac_alg=('processors', 'atmospheric_correction', 'land_ac_alg'),
    enable_segmentation=('processors', 'atmospheric_correction', 'enable_segmentation'),
    isofit_surface_optimization=('processors', 'atmospheric_correction', 'isofit_surface_optimization'),
    path_isofit_surface_config=('processors', 'atmospheric_correction', 'path_isofit_surface_config'),
    path_isofit_surface_priors=('processors', 'atmospheric_correction', 'path_isofit_surface_priors'),
